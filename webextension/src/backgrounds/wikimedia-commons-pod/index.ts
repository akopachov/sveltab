...
export const Background: BackgroundCatalogItem = {
  name: m.Backgrounds_WikimediaCommonsPod_Name,
  components: {
    provider: new WeakLazy(() => import('./provider').then(r => r.WikimediaCommonsPodBackgroundProvider)),
    settings: {
