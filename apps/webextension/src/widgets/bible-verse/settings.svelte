<script module lang="ts">
  ...
  const Tabs = [
    {
      id: TextTabId,
      title: () => m.Widgets_BibleVerse_Settings_Tabs_Text(),
    },
    {
      id: BackgroundTabId,
      title: () => m.Widgets_BibleVerse_Settings_Tabs_Background(),
    },
  ];
</script>
...
{#if tab === GeneralTabId}
  <div class="label mb-2">
    <span>{m.Widgets_BibleVerse_Settings_UpdateInterval()}</span>
